...
namespace Tests
{
    ...
    {
        private static readonly Dictionary<Type, Func<object, string>> Printable =
    ...
    [TestClass]
    public class TestTypeClasses
    {
        [TestMethod]
        public void TestShow_RegisteredTypes()
        {
        ...
        public void TestShow_UnknownType()
        {
            TypeClassesExamples.Show("foo");
        }

        [TestMethod]
        public void TestRegisterInstanceOfShow_NewType()
        {
